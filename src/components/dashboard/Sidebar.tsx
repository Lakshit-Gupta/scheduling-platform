...
import {
  ...
  Grid3X3, ChevronDown, Store, AppWindow, ExternalLink, Copy, Gift, Settings,
} from "lucide-react"
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-[240px] flex-col border-r border-neutral-800 bg-neutral-900">
      ...
      <div className="border-t border-neutral-800 px-3 py-3 space-y-0.5">
        <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-[13px] font-medium text-neutral-400 transition-all hover:bg-neutral-800 hover:text-neutral-100">
          <ExternalLink className="h-4 w-4" />View public page
        </button>
        <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-[13px] font-medium text-neutral-400 transition-all hover:bg-neutral-800 hover:text-neutral-100">
          <Copy className="h-4 w-4" />Copy public page link
        </button>
        <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-[13px] font-medium text-neutral-400 transition-all hover:bg-neutral-800 hover:text-neutral-100">
      ...
      <div className="border-t border-neutral-800 p-3">
        <div className="flex items-center gap-3 rounded-lg px-3 py-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-700 text-xs font-semibold text-neutral-100">AJ</div>
          <div className="min-w-0 flex-1">
            <p className="truncate text-[13px] font-medium text-neutral-100">Alex Johnson</p>
            <p className="truncate text-[11px] text-neutral-500">alex@example.com</p>
          </div>
        </div>
      </div>
    </aside>
